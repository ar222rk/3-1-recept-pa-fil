...
namespace FiledRecipes.Domain
{
    ...
    public class RecipeRepository : IRecipeRepository
    {
        ...
        public virtual void Load()
        {
            ...
            Recipe actualrecipes = null;

            using (StreamReader streamreader = new StreamReader(@"Recipes.txt"))
            {
                        ...
                        default:
                            switch (recipestatus)
                            {
                                case RecipeReadStatus.New:
                                    actualrecipes = new Recipe(line);
                                    recipes.Add(actualrecipes);
                                    break;
                                case RecipeReadStatus.Ingredient:
                                    ...
                                    actualrecipes.Add(ingredient);
                                    break;
                                case RecipeReadStatus.Instruction:
                                    actualrecipes.Add(line);
                                    break;
